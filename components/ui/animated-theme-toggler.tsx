...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "flex h-7 w-7 items-center justify-center rounded-md border border-border bg-surface text-text hover:bg-surface-hover hover:text-foreground transition-colors cursor-pointer",
        className
      )}
      {...props}
    >
